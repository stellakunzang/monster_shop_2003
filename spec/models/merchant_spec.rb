...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'merchant_orders' do
      ...
      chain = @meg.items.create(name: "Chain", description: "It'll never break!", price: 40, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 22)
      ball = dog_shop.items.create!(name: "Ball", description: "A ball for your dog", price: 12, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 13)
      order_1 = Order.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, user_id: @user.id)
      order_2 = Order.create!(name: 'Brian', address: '123 Brian Ave', city: 'Denver', state: 'CO', zip: 17033, user_id: @user.id)
      order_3 = Order.create!(name: 'Dao', address: '123 Mike Ave', city: 'Denver', state: 'CO', zip: 17033, user_id: @user.id)
      ...
      order_1.item_orders.create!(item: ball, price: ball.price, quantity: 1)

      order_2.item_orders.create!(item: chain, price: chain.price, quantity: 1)
      order_2.item_orders.create!(item: ball, price: ball.price, quantity: 1)
    ...
    it "#my_item_orders" do
      ...
      item_order_3 = order_1.item_orders.create!(item: ball, price: ball.price, quantity: 1)

      expect(@meg.my_item_orders(order_1.id)).to eq([item_order_1, item_order_2])
    end
  end
end
